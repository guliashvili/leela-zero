import { Ish, gGameState } from "./ish.go.view.h5.js";
import { Constants, GameState, Point, MoveResult } from "./ish.go.js";
...
Ish.Go.Logic = new (function () {
  ...
  this.isPointInBounds = function (point) {
    return (
      point &&
      point.row < gGameState.boardHeight &&
      point.row >= 0 &&
      point.column < gGameState.boardWidth &&
      point.column >= 0
    );
  };
  ...
  this.move = function (y, x) {
    ...
    gGameState.currentPlayer =
      player == gGameState.player1 ? gGameState.player2 : gGameState.player1;
